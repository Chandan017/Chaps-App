...
public final class ItemReceiveBinding implements ViewBinding {
  ...
  private ItemReceiveBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView reaction,
  ...
  public static ItemReceiveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReceiveBinding((ConstraintLayout) rootView, reaction, receivedMessage);
    }
